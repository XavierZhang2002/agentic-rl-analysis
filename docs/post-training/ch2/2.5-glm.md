...
<figure markdown="span">
  ![GLM-5 完整训练 Pipeline](../../images/post-training/glm5-pipeline.png){ width="95%" }
  <figcaption>GLM-5 的完整训练 Pipeline：Pre-training → Mid-training → Post-Training（SFT → Reasoning RL → Agentic RL → General RL）+ Cross-Stage Distillation（图源：arXiv:2602.15763）</figcaption>
</figure>
...
<figure markdown="span">
  ![GLM-5 Interleaved Thinking 模式](../../images/post-training/glm5-thinking-modes.png){ width="95%" }
  <figcaption>GLM-5 的 Interleaved Thinking：在每次工具调用前都生成推理过程，支持 Preserved Thinking 跨轮保留推理历史（图源：arXiv:2602.15763）</figcaption>
</figure>
