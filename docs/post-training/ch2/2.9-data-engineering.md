...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#e8eaf6', 'primaryTextColor': '#1a237e', 'primaryBorderColor': '#5c6bc0', 'lineColor': '#7986cb', 'secondaryColor': '#f3e5f5', 'tertiaryColor': '#e0f2f1', 'fontFamily': 'Noto Sans SC, sans-serif', 'fontSize': '13px'}}}%%
flowchart LR
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#e8eaf6', 'primaryTextColor': '#1a237e', 'primaryBorderColor': '#5c6bc0', 'lineColor': '#7986cb', 'secondaryColor': '#fff3e0', 'tertiaryColor': '#e0f2f1', 'fontFamily': 'Noto Sans SC, sans-serif', 'fontSize': '13px'}}}%%
flowchart LR
    Q(["问题"]) -->|"采样 k 次"| R["k 个候选"]
    R --> F{"验证器"}
    F -->|"正确"| D([SFT 数据])
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#e8eaf6', 'primaryTextColor': '#1a237e', 'primaryBorderColor': '#5c6bc0', 'lineColor': '#7986cb', 'fontFamily': 'Noto Sans SC, sans-serif', 'fontSize': '13px'}}}%%
flowchart LR
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#e8eaf6', 'primaryTextColor': '#1a237e', 'primaryBorderColor': '#5c6bc0', 'lineColor': '#7986cb', 'secondaryColor': '#ffebee', 'fontFamily': 'Noto Sans SC, sans-serif', 'fontSize': '13px'}}}%%
flowchart LR
