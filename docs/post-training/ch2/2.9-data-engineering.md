...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#eef0fb', 'primaryTextColor': '#303680', 'primaryBorderColor': '#9ba3d6', 'lineColor': '#9ba3d6', 'secondaryColor': '#f8f8fc', 'tertiaryColor': '#ffffff', 'tertiaryBorderColor': '#d8dbe8', 'clusterBkg': '#ffffff', 'clusterBorder': '#d8dbe8', 'edgeLabelBackground': '#ffffff', 'fontFamily': 'Noto Sans SC, sans-serif', 'fontSize': '13px'}}}%%
flowchart LR
