---
title: 1.1 大模型训练全景
description: 大模型训练三阶段（预训练、中间训练、后训练）的全景概览与趋势分析。
tags:
  - 训练全景
  - 预训练
  - SFT
...
<figure markdown="span">
  ![Post-Training 技术分类体系](../../images/post-training/survey-taxonomy.png){ width="100%" }
  <figcaption>LLM Post-Training 技术分类全景：涵盖 Technique（Fine-Tuning / Alignment / Reasoning / Efficiency）、Dataset 和 Application 三大维度（图源：arXiv:2503.06072）</figcaption>
</figure>
